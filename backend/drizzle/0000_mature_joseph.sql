CREATE TYPE "public"."account_type" AS ENUM('oauth', 'oidc', 'email');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"image" varchar(255),
	"is_active" varchar(50) DEFAULT 'true' NOT NULL,
	"is_verified" varchar(50) DEFAULT 'false' NOT NULL,
